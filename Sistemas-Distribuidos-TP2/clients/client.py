...
def cliente_thread(cliente_id, sync_host):
    ...
    # Cada cliente faz 1 tentativas de acesso ao recurso R
...
if __name__ == "__main__":
    ...
    for i in range(CLIENTS_NUMBER):
        cliente_id = f"client_{i+1}"           # Gera um ID legível para o cliente
        sync_node = f"sync{i+1}"               # Nome do nó do Cluster Sync a ser contatado
